...
def bbox_points_cam(depth_m: np.ndarray, box, stride=PIX_STRIDE):
...
def main():
    ...
    for i, (ts, rgb_rel) in enumerate(rgb_frames):
        ...
        for det in detections:
            ...
            pts_cam = bbox_points_cam(depth_m, box)
            if pts_cam is None:
                continue
    ...
    export_semantic_ply(semantic, ply_out="freiburg1_semantic_voxels.ply", min_weight=2.0)
